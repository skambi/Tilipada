...
var PATCH = 0x200D; // zwj (for cases like ar.ka with ka vattu, instead of regular arka with arr)
var BEREMADU = 0x200C; // zwnj (to explicitly separate like soft.ware)
...
function kelasaMaadi(tarea, tevent) {
  ...
  // 'X' ge hosa akshara shuru (haledu separate)
  if (eeginaKey == 88) {
    haleVyanjanaKathe = 00;
    hindhinaKey = 0;
    Thorisu(0, BEREMADU, false);
    return false;
  }
